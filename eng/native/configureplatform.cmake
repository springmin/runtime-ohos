...
# CMAKE_SYSTEM_NAME=OHOS. OpenHarmony is not a Linux flavor (its kernel is not
# guaranteed to be Linux), so it keeps its own OS identity instead of being
# remapped to linux; the properties it inherits are declared explicitly below.
# Its libc is musl-based, which is a factual inheritance, not a "pretend to be
# Linux" remap.
