...
- **已实现（特性探测）6 项**：Share、Scan、Push、Account、Map（方案 (b)）、LiveView——自「有条件可补齐」转入；真机点亮待 HMS 设备 + AGC 开通/审批；**仅记录 2 项**：Payment、Ads；**维持门控 6 项**：TTS（双否）、Hot Reload、arm32、WebAuthenticator、SecureStorage 兜底、MediaElement。
