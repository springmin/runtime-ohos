...
**发布：** kit #18（`device-test-kit`，2026-09-23T16:50+08:00；壳/宿主/脚本 = `ohos-workload 49cd70f3d1..2857837`，托管面 = `maui-ohos c730226f93`）已含全部修复；`sdk-ohos 690134e706` 的安装器/签名加固随 sdk 分支及其 release 链发布。
