...
// TARGET_OPENHARMONY: the sandbox denies PROT_EXEC on the file-backed mappings the W^X
// allocator uses; anonymous executable memory is allowed, so default to the RWX allocator.
